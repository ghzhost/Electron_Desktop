/*! For license information please see 8764.de7b5fad116eb5e3a6ac.bundle.js.LICENSE.txt */
    ...
    [8764], {
        ...
        48764: (t, e, r) => {
            ...
            function a(t, e, r) {
                ...
                if (Z(t, ArrayBuffer) || t && Z(t.buffer, ArrayBuffer)) return y(t, e, r);
                if ("undefined" != typeof SharedArrayBuffer && (Z(t, SharedArrayBuffer) || t && Z(t.buffer, SharedArrayBuffer))) return y(t, e, r);
                ...
                const o = function(t) {
                    ...
                    return void 0 !== t.length ? "number" != typeof t.length || H(t.length) ? u(0) : l(t) : "Buffer" === t.type && Array.isArray(t.data) ? l(t.data) : void 0
                }(t);
                if (o) return o;
            ...
            e.kMaxLength = s, h.TYPED_ARRAY_SUPPORT = function() {
                ...
                for (r = 0; r < t.length; ++r) {
                    let e = t[r];
                    if (Z(e, Uint8Array)) o + e.length > n.length ? (h.isBuffer(e) || (e = h.from(e)), e.copy(n, o)) : Uint8Array.prototype.set.call(n, e, o);
                    else {
            ...
            D("ERR_BUFFER_OUT_OF_BOUNDS", (function(t) {
                ...
                let n = `The value of "${t}" is out of range.`,
                    o = r;
                return Number.isInteger(r) && Math.abs(r) > 2 ** 32 ? o = z(String(r)) : "bigint" == typeof r && (o = String(r), (r > BigInt(2) ** BigInt(32) || r < -(BigInt(2) ** BigInt(32))) && (o = z(o)), o += "n"), n += ` It must be ${e}. Received ${o}`, n
            }), RangeError);
